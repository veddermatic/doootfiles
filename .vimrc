...
set tabstop=2 " tab counts as 4 spaces
set softtabstop=2 " make spces like tabs when deleting
set shiftwidth=2 " number of spaces to move text with '>>' and '<<'
...
let g:ctrlp_custom_ignore = {'dir': '\v[\/](\.git|node_modules|elm-stuff|\.sass-cache|dist|build)$' }
" }}}
